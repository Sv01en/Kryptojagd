...
class ReadJSONTest {
	...
	void testCreateMultipleChoiceQuestion() {
		...
		String correctAnswer = "Ja, der Text kann sonst von jedem gelesen werden und das wäre nicht sicher.";
		String[] possibilities = {"Nein, der Verfasser wollte sich nur einen Spaß erlauben.", 
				"Ja, der Text kann sonst von jedem gelesen werden und das wäre nicht sicher.",
				"Ja, denn der Verfasser kommt vermutlich aus einem Land indem es üblich ist Texte so zu schreiben."};
	...
	void testCreateDecryptionTask() {
		...
		String plainText = "In der Stadt mit einem eisernen Turm und der glaesernen Pyramide "
				...
				+ "Jeden morgen kann sie die vielseitigen Klaenge der Glocken hoeren, die Quasimodo liebevoll umsorgt.";
		String encryptionMethod = "Rückwärtsverschlüsselung";
		String[] answerOptionsEncryption = {"Rückwärtsverschlüsselung", "RSA Verschlüsselung", "Cäsar Verschlüsselung"};
